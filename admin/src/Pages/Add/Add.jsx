        ...
        <form className='flex-col' onSubmit={onSubmitHandler} >
           ...
           <div className="add-product-name flex-col">
            ...
            <div className="add-product-author flex-col">
                <p>Author name</p>
                <textarea onChange={onchangeHandler} value={data.author} name='author' rows={3} placeholder='Write author name here'></textarea>
            </div>
            <div className='add-category-price'>
                <div className="add-categoy flex-col" >
                    <p>Product category</p>
                    <select onChange={onchangeHandler} name="category">
                        <option value="Art & Photography"></option>
                        <option value="Business & Economics"></option>
                        <option value="Bio-graphy"></option>
